...
<head>
    ...
    <title>Greendale Community Trust Website</title>
</head>
<body>
    <nav class="static">
    ...
    <div class="page-content">
        <article>
            <div class="article-header-image">
                <img src="../images/greendale_community_trust/greendale_community_trust_2.jpg" alt="Photo of a New Zealand Forest">
                <span class="article-header-caption">Photo of some Californian Redwoods, one of the many trees at the T W Adams Arboretum. Learn more <a href="https://greendalecommunitytrust.co.nz/content/tree?treeID=10">here</a>.</span>
            </div>
            <section class="article-text">
                <div class="article-heading">
                    <h1>Greendale Community Trust Website</h1>
                ...
                <section class="table-of-contents">
                    <ol>
                        ...
                        <li><a href="#frontend">Front End Design</a></li>
                        <li><a href="#backend">Back End Design</a></li>
                ...
                <section id="requirements">
                    ...
                    <p>From an initial meeting, I learnt the website must do the following things:</p>
                    <ul>
                        <li>Provide a home page for the Greendale Community Trust, allowing visitors to learn more about their work.</li>
                        <li>Provide an effective way for visitors to see and learn more about all the tree's in the Arboretum.</li>
                        <li>Allow a visitor to view a specific tree after scanning its QR code.</li>
                        <li>Allow a visitor to report damage to any tree in the Arboretum.</li>
                ...
                <section id="frontend">
                    ...
                    <div class="triple-image-container">
                        <div class="triple-image">
                            ...
                            <span class="image-caption">Figure 1: Homepage of the website</span>
                        </div>
                        <div class="triple-image">
                            <img src="../images/greendale_community_trust/greendale_community_trust_web_2.png" alt="Arboretum page of the website">
                            <span class="image-caption">Figure 2: Arboretum page of the website</span>
                        </div>
                        <div class="triple-image">
                            <img src="../images/greendale_community_trust/greendale_community_trust_web_3.png" alt="Specific tree page of the website">
                            <span class="image-caption">Figure 3: Specific tree page of the website</span>
                        </div>
                    </div>
                    <p>The website made minimal use of JavaScript, which I primarily used for the mobile menu. There is some more complex javascript used to facilitate asynchronous form submission and image uploading in the admin panel.</p>
                </section>
                <section id="backend">
                    ...
                    <div class="triple-image-container">
                        <div class="triple-image">
                            ...
                            <span class="image-caption">Figure 4: Login page for admin panel</span>
                        </div>
                        <div class="triple-image">
                            <img src="../images/greendale_community_trust/greendale_community_trust_web_5.png" alt="Homepage of admin panel">
                            <span class="image-caption">Figure 5: Homepage of admin panel</span>
                        </div>
                        <div class="triple-image">
                            <img src="../images/greendale_community_trust/greendale_community_trust_web_6.png" alt="Edit page for specific tree">
                            <span class="image-caption">Figure 6: Edit page for specifc tree</span>
                        </div>
                    </div>
                </section>
                ...
                <section id="learning">
                    ...
                    <p>Below are some learning highlights.</p>
                    <div class="learning-sections">
                        <div class="learning-section">
                            <h3>Frontend</h3>
                            <ul>
                                <li>Writing HTML / CSS that is semantic and is widely compatible.</li>
                                <li>Creating extendable and straightforward designs.</li>
                            </ul>
                        </div>
                        <div class="learning-section">
                            <h3>Backend</h3>
                            <ul>
                                <li>Getting experience writing PHP in a functional and OOP style.</li>
                                <li>Using SHA256 to hash user passwords before storing them in a database.</li>
                                <li>Getting experience writing SQL queries.</li>
                                <li>Using SESSION global variables to store the credentials of a logged-in user safely.</li>
                                <li>Learning how to use composer to use PHP libraries, such as the image manipulation library I used for the admin panel.</li>
                            </ul>
                        </div>
                        <div class="learning-section">
                            <h3>Website Configuration</h3>
                            <ul>
                                <li>Configuring domain and hosting.</li>
                                <li>Using FTP to upload website files.</li>
                                <li>Using git to facilitate continuous deployment.</li>
                            </ul>
                        </div>
                        <div class="learning-section">
                            <h3>Communication</h3>
                            <ul>
                                <li>Communicating with clients in helpful ways. Providing options and helping the client to articulate design and functionality desires.</li>
                                <li>Establishing a consistent link structure with the sign maker ensuring that the QR codes led to the appropriate tree.</li>
                            </ul>
                        </div>
                    </div>
                </section>
